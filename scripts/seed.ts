...
async function main() {
  ...
  try {
    ...
    const taxSchemes = [
      { taxSchemeId: "1000", taxSchemeName: "IGV", taxPercentage: 0.18, isActive: true },
      { taxSchemeId: "9997", taxSchemeName: "Exonerado", taxPercentage: 0.0, isActive: true },
      { taxSchemeId: "9998", taxSchemeName: "Inafecto", taxPercentage: 0.0, isActive: true },
      { taxSchemeId: "2000", taxSchemeName: "ISC", taxPercentage: 0.1, isActive: true },
      { taxSchemeId: "9999", taxSchemeName: "Otros", taxPercentage: 0.0, isActive: true },
    ]
