...
-- CreateEnum
CREATE TYPE "ConciliationItemType" AS ENUM ('DOCUMENT_TRANSACTION', 'TRANSACTION_ONLY', 'DOCUMENT_ONLY', 'ADJUSTMENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "transactions_bankAccountId_operationNumber_transactionDate_key" ON "transactions"("bankAccountId", "operationNumber", "transactionDate");
...
-- CreateIndex
CREATE INDEX "conciliation_items_transactionId_idx" ON "conciliation_items"("transactionId");
...
-- AddForeignKey
ALTER TABLE "conciliation_items" ADD CONSTRAINT "conciliation_items_transactionId_fkey" FOREIGN KEY ("transactionId") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
