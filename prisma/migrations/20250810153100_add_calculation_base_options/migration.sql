...
ALTER TYPE "CalculationBase" ADD VALUE 'RETENTION_AMOUNT';
ALTER TYPE "CalculationBase" ADD VALUE 'DETRACTION_AMOUNT';
ALTER TYPE "CalculationBase" ADD VALUE 'NET_PAYABLE';
ALTER TYPE "CalculationBase" ADD VALUE 'PENDING_AMOUNT';
ALTER TYPE "CalculationBase" ADD VALUE 'CONCILIATED_AMOUNT';
...
-- AlterTable
ALTER TABLE "accounting_entry_lines" ALTER COLUMN "id" SET DEFAULT 'ael_' || substr(gen_random_uuid()::text, 1, 13);

-- AlterTable
ALTER TABLE "accounting_entry_template_lines" ALTER COLUMN "id" SET DEFAULT 'aetl_' || substr(gen_random_uuid()::text, 1, 13);
