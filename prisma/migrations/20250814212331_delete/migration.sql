/*
  ...
  - You are about to drop the column `currentBalance` on the `bank_accounts` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "bank_accounts" DROP COLUMN "currentBalance",
